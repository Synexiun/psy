'use client';
/**
 * Textarea — standalone Quiet Strength–tokenised primitive.
 *
 ...
 *
 * API is intentionally identical to the Textarea exported from web.tsx;
...
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  function Textarea(
    ...
    const base =
      'w-full rounded-lg border border-border-subtle bg-surface-primary px-3 py-2.5 text-sm text-ink-primary placeholder:text-ink-tertiary transition-colors min-h-[88px]';
    const focusCls =
