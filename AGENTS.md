# AGENTS.md — Guidance for Codex sessions

This file tells Codex what kind of project this is and how to be useful here. Read first.
...
The full spec is in `Docs/bUSINESS/` (12 files), `Docs/Technicals/` (17 files, 00–16), `Docs/Whitepapers/` (peer-reviewed-citation foundation docs), and `Docs/Help/` (per-locale shipped help articles). If anything in this AGENTS.md conflicts with those docs, **the docs win**. Update this file to match, don't edit away from them.
...
- **LLM:** Anthropic Codex API — Haiku 4.5 / Sonnet 4.6 routed. Never Opus in user-visible path. Never on a crisis path.
