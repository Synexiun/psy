...
export function StreakWidget({ data, isLoading }: StreakWidgetProps) {
  if (isLoading || !data) {
    return (
      <div className="flex items-center gap-6 rounded-xl border border-surface-200 bg-surface-0 p-6 shadow-sm">
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="flex items-center gap-5 rounded-xl border border-surface-200 bg-surface-0 p-5 shadow-sm transition-shadow hover:shadow-md">
        <ProgressRing
        ...
        <div className="min-w-0">
          <p className="text-sm font-medium text-ink-900">Continuous streak</p>
      ...
      <div className="flex items-center gap-5 rounded-xl border border-surface-200 bg-surface-0 p-5 shadow-sm transition-shadow hover:shadow-md">
        ...
        />
        <div className="min-w-0">
          <p className="text-sm font-medium text-ink-900">Resilience streak</p>
          <p className="mt-0.5 text-sm text-ink-500">
